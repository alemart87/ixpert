...
def call_openai(messages):
    ...
    # GPT-5.x usa max_completion_tokens (no max_tokens). Si volves a un modelo
    # de la familia GPT-4 hay que renombrar el parametro de vuelta.
    payload = json.dumps({
        'model': 'gpt-5.4-mini',
        'messages': messages,
    ...
    try:
        ...
        # Capturamos body para diagnostico (parametros invalidos, modelo sin acceso, etc.)
        body = ''
        try:
